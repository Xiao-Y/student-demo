		...
		<fieldset class="layui-elem-field">
			...
			<div class="layui-field-box">
				...
				<fieldset class="layui-elem-field layui-field-title">
					...
					<div class="layui-field-box">
						<p>
							1、navbar组件 添加属性 <cite style="color: #1AA094;">spreadOne </cite>"设置是否只展开一个二级菜单，默认为false"
						</p>
					</div>
				</fieldset>
				<fieldset class="layui-elem-field layui-field-title">
				...
				<fieldset class="layui-elem-field layui-field-title">
					...
					<div class="layui-field-box">
						...
						<p>3、top样式修改</p>
						<p>
							4、修复直接选中checkbox时背景色没变化，感谢
							<a href="http://fly.layui.com/u/2451288/" target="_blank">@瀮月</a>
							的反馈
						</p>
					</div>
				</fieldset>
