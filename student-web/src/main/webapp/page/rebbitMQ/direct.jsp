...
<script type="text/javascript" src="${ctx }/page/rebbitMQ/direct.js"></script>
</head>
	...
	<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
		...
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show">
				<form id="formLeave" class="layui-form layui-form-pane1" style="margin: 15px;" data-type="ajax" action="${ctx }/rebbitMQ/queueSender/true">
			...
			<div class="layui-tab-item">
				<div style="margin: 15px;">
					...
					<div class="layui-form-item">
						<input type="hidden" class="pathUrl" value="${ctx }/rebbitMQ/readQueueMessage/true">
						<button class="layui-btn" name="readMsgBt" type="button">读取默认</button>
					</div>
				</div>
			</div>
			<div class="layui-tab-item">
				<form id="formLeave" class="layui-form layui-form-pane1" style="margin: 15px;" data-type="ajax" action="${ctx }/rebbitMQ/queueSender/false">
					<div class="layui-form-item layui-form-text">
						<textarea placeholder="请输入内容" lay-verify="required" class="layui-textarea" name="message"></textarea>
					</div>
					<div class="layui-form-item">
			...
			<div class="layui-tab-item">
				<div style="margin: 15px;">
					...
					<div class="layui-form-item">
						<input type="hidden" class="pathUrl" value="${ctx }/rebbitMQ/readQueueMessage/false">
						<button class="layui-btn" name="readMsgBt" type="button">读取</button>
					</div>
				</div>
			</div>
			<div class="layui-tab-item">
				<form id="formLeave" class="layui-form layui-form-pane1" style="margin: 15px;" data-type="ajax" action="${ctx }/rebbitMQ/queueListenerSender">
					<div class="layui-form-item layui-form-text">
						<textarea placeholder="请输入内容" lay-verify="required" class="layui-textarea" name="message"></textarea>
					</div>
					<div class="layui-form-item">
