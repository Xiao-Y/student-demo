...
<script type="text/javascript" src="${ctx }/static/page/activiti/apply/form-key/leaveApplyList.js"></script>
...
<body>
	<div class="admin-main">
		<blockquote class="layui-elem-quote">
			<a href="${ctx }/formkey/applyLeave/editLeave" class="layui-btn layui-btn-small">
					...
					<tbody>
						<c:forEach var="leave" items="${page.list}">
							...
							<tr>
								...
								<td>
									<a target="_blank" title="点击查看流程图" href='${ctx }/sysAct/openActivitiProccessImagePage/leaveComment/${leave.processInstanceId }'>
										${leave.taskName } </a>
								</td>
								<td>
